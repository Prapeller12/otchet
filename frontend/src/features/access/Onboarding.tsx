...
const steps = [
  ...
  { title: "Заполните таблицу", text: "Дважды нажмите на нужную ячейку, введите число и нажмите Enter. Расчётные ячейки программа заполняет сама. Наведите на такую ячейку указатель: подсказка объяснит, что нужно заполнить для расчёта. Ноль означает, что количества нет. Пустая ячейка — данных пока нет." },
